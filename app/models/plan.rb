class Plan < ActiveRecord::Base
  ...
  validates :interval_count, numericality: { less_than: 13 }, if: Proc.new {|plan| plan.interval == 'month'}
  validates :interval_count, numericality: { less_than: 53 }, if: Proc.new {|plan| plan.interval == 'week'}
