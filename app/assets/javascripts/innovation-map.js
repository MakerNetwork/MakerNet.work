...
// const?
var myIcon = L.icon({
    iconUrl: 'http://atlasofinnovation.com/static/images/pin1.png',
    iconSize: [23, 30],
    iconAnchor: [11, 29],
    popupAnchor: [0, -30]
});
...
$.get('http://atlasofinnovation.com/api/space/filter/?not_closed=True&fields=latitude,longitude,name,city,country,website,short_description,id',{cache: true}, function(spaces) {
	buildMarkers(spaces);
});
...
function createPopup(space) {
	...
	popupText += "</div>";
	popupText += "<p><img src='http://atlasofinnovation.com/static/images/pin2.png' \
						  height='14' \
	...
	popupText += "<a href='http://atlasofinnovation.com/space/"+space.id+"'><img src='http://atlasofinnovation.com/static/images/space_page.png' class='space-page-button'></a>";
