...
prepare_config()
{
  ...
  \curl -sSL https://gist.githubusercontent.com/MakerNetwork/1393013db25bfe9bf1ccf3dfab49cead/raw/f96a5dbd73e0eac51ed0c9ba29f3ad2c1162c810/env.example > "$MAKERNET_PATH/example/env.example"
