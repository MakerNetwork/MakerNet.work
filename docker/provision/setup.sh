...
prepare_config()
{
  ...
  \curl -sSL https://gist.githubusercontent.com/MakerNetwork/1393013db25bfe9bf1ccf3dfab49cead/raw/a69abbf6876dd71e989c84b77ab3765601c9656e/env.example > "$MAKERNET_PATH/example/env.example"
